...
data class DisplaySettings(
    ...
    val romIconPopUpShowNds: Boolean = true,
    val romIconPopUpShowPsp: Boolean = true,
    val romIconPopUpShowAndroid: Boolean = true,
    val romIconPopUpShowDefault: Boolean = true,
    val romIconPopUpShowInGridStyle: Boolean = true,
    ...
    val showRomDetailsInGridStyle: Boolean = true,
    val showRomFavoriteButton: Boolean = true,
    val showRomFavoriteInGridStyle: Boolean = true,
    val showRomCompleteButton: Boolean = true,
    val showRomCompleteInGridStyle: Boolean = true,
