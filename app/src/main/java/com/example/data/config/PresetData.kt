    ...
    fun getDefaultSystems(baseFolder: String): List<SystemEntity> {
        return listOf(
            ...
            SystemEntity(
                ...
                name = "Super Nintendo",
                shortName = "SNES",
                folderPath = "$baseFolder/example/snes",
            ...
            SystemEntity(
                ...
                name = "PlayStation 2",
                shortName = "PS2",
                folderPath = "$baseFolder/example/ps2",
            ...
            SystemEntity(
                ...
                name = "Nintendo 3DS",
                shortName = "3DS",
                folderPath = "$baseFolder/example/3ds",
            ...
            SystemEntity(
                ...
                shortName = "PSP",
                folderPath = "$baseFolder/example/psp",
            ...
            SystemEntity(
                ...
                name = "Nintendo 64",
                shortName = "N64",
                folderPath = "$baseFolder/example/n64",
            ...
            SystemEntity(
                ...
                shortName = "GBA",
                folderPath = "$baseFolder/example/gba",
            ...
            SystemEntity(
                ...
                name = "PlayStation 1",
                shortName = "PS1",
                folderPath = "$baseFolder/example/ps1",
            ...
            SystemEntity(
                ...
                name = "GameCube & Wii",
                shortName = "GC / Wii",
                folderPath = "$baseFolder/example/gc_wii",
            ...
            SystemEntity(
                ...
                name = "Arcade",
                shortName = "ARCADE",
                folderPath = "$baseFolder/example/arcade",
